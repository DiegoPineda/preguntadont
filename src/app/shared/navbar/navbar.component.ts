...
export class NavbarComponent {
  constructor(private sharingObservableTienda: SharingService, private authService: AuthService, private router: Router,private usuarioService: UsuarioService, private usuarioTiendaService: UsuarioTiendaService){
...
actualizarNavbar(){
  ...
  if (this.idActual !== undefined) {
    this.getInfoTienda(this.idActual).pipe(
      tap((tienda) => {
        this.tiendaUsuario = tienda;
      }),
      catchError((error) => {
